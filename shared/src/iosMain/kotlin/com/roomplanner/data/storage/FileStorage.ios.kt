...
actual class FileStorage {
    ...
    actual suspend fun saveProject(project: Project): Result<Unit> = runCatching {
        ...
        val success = (jsonString as NSString).writeToFile(
            metadataPath,
            atomically = true,
    ...
    actual suspend fun loadProject(projectId: String): Result<Project> = runCatching {
        val metadataPath = projectsDir
    ...
    actual suspend fun listProjects(): Result<List<Project>> = runCatching {
    ...
    actual suspend fun deleteProject(projectId: String): Result<Unit> = runCatching {
    ...
    actual suspend fun saveSettings(settings: Settings): Result<Unit> = runCatching {
    ...
    actual suspend fun loadSettings(): Result<Settings> = runCatching {
        val settingsPath = documentsDir.URLByAppendingPathComponent("settings.json")!!.path!!
